...
# ─── Page Config ────────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="Media Intelligence AI",
    page_icon="🎬",
    layout="wide",
...
# ─── Main Area ──────────────────────────────────────────────────────────────────
st.markdown('<div class="hero-title"><center>TubeTalk AI</center></div>', unsafe_allow_html=True)
st.markdown('<div class="hero-sub"><center>Transcribe · Summarise · Chat with your meetings</center></div>', unsafe_allow_html=True)
st.markdown("---")
    ...
    if not source.strip():
        ...
        try:
            with progress_placeholder.container():
                st.info("⚙️ Pipeline is running behind — wait for a moment…")
...
<div class="custom-footer">
    Developed by <span class="name">Amit Kumar Rana</span> 🚀
</div>
""", unsafe_allow_html=True)